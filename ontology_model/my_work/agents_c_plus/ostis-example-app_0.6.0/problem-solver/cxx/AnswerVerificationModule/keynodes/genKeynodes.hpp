...
namespace answerVerificationModule
{
    ...
    public:
        ...
        SC_PROPERTY(Keynode("fill_in_the_blank_questions_based_on_relation_identifier"), ForceCreate)
        static ScAddr fill_in_the_blank_questions_based_on_relation_identifier;

        SC_PROPERTY(Keynode("fill_in_the_blank_questions_based_on_axiomatics"), ForceCreate)
        static ScAddr fill_in_the_blank_questions_based_on_axiomatics;

        SC_PROPERTY(Keynode("fill_in_the_blank_questions_based_on_image_examples"), ForceCreate)
        static ScAddr fill_in_the_blank_questions_based_on_image_examples;
        ...
        SC_PROPERTY(Keynode("judgment_questions_based_on_inclusion_relation"), ForceCreate)
        static ScAddr judgment_questions_based_on_inclusion_relation;

        SC_PROPERTY(Keynode("judgment_questions_of_choosing_false"), ForceCreate)
        static ScAddr judgment_questions_of_choosing_false;
        ...
        SC_PROPERTY(Keynode("judgment_questions_based_on_image_examples"), ForceCreate)
        static ScAddr judgment_questions_based_on_image_examples;
